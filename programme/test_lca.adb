...
procedure Test_LCA is
    ...
    procedure Afficher (D : in Unbounded_String;
                        M : in Integer
                        P : in 
                        F : in ) is
    begin
    ...
    procedure Construire_Exemple_Sujet (Annuaire : out T_LCA; Bavard: Boolean := True) is
    begin

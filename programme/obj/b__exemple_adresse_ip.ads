...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_exemple_adresse_ip" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#0114a025#;
   pragma Export (C, u00001, "exemple_adresse_ipB");
